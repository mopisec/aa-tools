...
CONFIG_MAP = [
    ...
    ['Unused (B)',          FIELD_TYPE_BYTES,   0x174, 0x001, False, 0x00, False, 0x00],     
    ['Unused (C)',          FIELD_TYPE_BYTES,   0x175, 0x104, True,  0x0B, True,  0xF5],
    ['Unused (D)',          FIELD_TYPE_STRING,  0x279, 0x028, True,  0x0B, False, 0x00],
    ['Data File Key',       FIELD_TYPE_BYTES,   0x2A1, 0x001, False, 0x00, False, 0x00],
    ['Unused (E)',          FIELD_TYPE_BYTES,   0x2A2, 0x001, False, 0x00, False, 0x00],
    ['Unused (F)',          FIELD_TYPE_BYTES,   0x2A3, 0x104, True,  0xCE, False, 0x00],
